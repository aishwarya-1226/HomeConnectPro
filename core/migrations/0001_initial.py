    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, help_text='Designates whether this user should be treated as active. Unselect this instead of deleting accounts.', verbose_name='active')),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now, verbose_name='date joined')),
                ('user_role', models.CharField(choices=[('client', 'Client'), ('property_purchaser', 'Property Purchaser'), ('salesperson', 'Salesperson')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_purchaser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.propertypurchaser')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.user')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_closing_time', models.DateTimeField()),
